...
INSERT INTO Players VALUES ('ID', `NUMBER`, `NAME`, `AGE`, `CLUB`, `COUNTRY`, `SALARY`),
    ...
    ('006', '6', 'Pogba', 30, 'Juventus', 'France', '450000'),
...
-- equal 
select * from Players where SALARY = 300000;

-- not equal
select * from players where SALARY != 300000;

-- greater than
select * from players where id > 007;

-- LESS THAN
select * FROM players where ID < 010;
...
-- and
-- select * from players where id > 007 and name = 'Ozil';

-- or
select * from players where id > 007 or name = 'Messi';

-- between
select * from players where id between 007 and 010;

-- not
select * from players where not SALARY = 300000